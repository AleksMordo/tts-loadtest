...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in cosyvoice_pb2_grpc.py depends on'
...
def add_CosyVoiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('cosyvoice.CosyVoice', rpc_method_handlers)
